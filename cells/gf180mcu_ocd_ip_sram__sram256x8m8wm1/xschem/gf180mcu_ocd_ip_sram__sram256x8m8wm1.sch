...
C {lcol4_256_3v256x8m81.sym} 100 150 0 0 {name=x1}
C {rcol4_256_3v256x8m81.sym} 100 390 0 0 {name=x2}
C {xdec64_3v256x8m81.sym} -460 280 0 0 {name=x3}
...
C {control_3v256x8m81.sym} -640 30 0 0 {name=x4}
...
C {ipin.sym} -860 -100 0 0 {name=p30 lab=A[7:0]}
