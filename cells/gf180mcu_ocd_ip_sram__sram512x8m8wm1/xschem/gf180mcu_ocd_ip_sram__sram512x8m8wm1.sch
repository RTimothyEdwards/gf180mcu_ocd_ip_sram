...
S {}
E {}
T {xc[3:2] used for the 1kB macro} -760 390 0 0 0.3 0.3 {}
...
C {lcol4_512_3v512x8m81.sym} 100 150 0 0 {name=x1}
C {rcol4_512_3v512x8m81.sym} 100 390 0 0 {name=x2}
C {xdec64_3v512x8m81.sym} -460 280 0 0 {name=x3}
...
C {lab_pin.sym} -650 270 0 0 {name=p24 sig_type=std_logic lab=xc[1:0]}
...
C {lab_pin.sym} -830 0 0 0 {name=p42 sig_type=std_logic lab=VSS,A[8:0]}
C {lab_pin.sym} -830 -100 0 1 {name=p43 sig_type=std_logic lab=A[8:0]}
